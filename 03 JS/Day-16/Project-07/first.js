...
form.addEventListener('submit',(e)=>{
    ...
    const day=parseInt(Day.value); //necessary to parseInt
    ...
    Result.textContent = ` Hello ${fname} ${sname} nice to meet you , your zodic siqn is
    ${zodiacSigns[month-1]}, you are ${compliments[day-1]} the happen to you ${victimCardCompliments[fname.length%20]} 
    the recommendation for you is ${recommendations[day-1]} and the prediction for you is ${predictions[sname.length%20]} in
    the near time`
    form.reset()
